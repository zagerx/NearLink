...
#define oml_glp_log_print0(lvl, fmt) \
    log_event_print0(log_head_press(OM_GLP), para_press(LOG_GLPMODULE, lvl, THIS_FILE_ID, __LINE__))
#define oml_glp_log_print1(lvl, fmt, p1) \
    log_event_print1(log_head_press(OM_GLP), para_press(LOG_GLPMODULE, lvl, THIS_FILE_ID, __LINE__), (uint32_t)(p1))
#define oml_glp_log_print2(lvl, fmt, p1, p2) \
    log_event_print2(log_head_press(OM_GLP), para_press(LOG_GLPMODULE, lvl, THIS_FILE_ID, __LINE__), (uint32_t)(p1), \
                     (uint32_t)(p2))
#define oml_glp_log_print3(lvl, fmt, p1, p2, p3) \
    log_event_print3(log_head_press(OM_GLP), para_press(LOG_GLPMODULE, lvl, THIS_FILE_ID, __LINE__), (uint32_t)(p1), \
                     (uint32_t)(p2), (uint32_t)(p3))
#define oml_glp_log_print4(lvl, fmt, p1, p2, p3, p4) \
    log_event_print4(log_head_press(OM_GLP), para_press(LOG_GLPMODULE, lvl, THIS_FILE_ID, __LINE__), (uint32_t)(p1), \
                     (uint32_t)(p2), (uint32_t)(p3), (uint32_t)(p4))
#define oml_glp_log_print_alter(lvl, fmt, num, arg...) \
    log_event_print_alterable_para_press(log_head_press(OM_GLP), \
                                         para_press(LOG_GLPMODULE, lvl, THIS_FILE_ID, __LINE__), num, ##arg)
#define glp_log_alter(lvl, fmt, num, arg...) oml_app_log_print_alter(LOG_GLPMODULE, lvl, fmt, num, ##arg)
