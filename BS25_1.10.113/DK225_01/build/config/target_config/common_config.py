...
component_set = {
    ...
    'ux_manager': ['fsm_box', 'fsm_master', 'fsm_pairing', 'ux_event', 'ux_earphone', 'ux_timer', 'ux_tone', 'ux_tone_config', 'ux_led_porting', 'ux_led_config',
    ...
    'codec_set': ['l2hc_dec_flash_16k', 'l2hc_dec_itcm_16k', 'l2hc_dec_flash_48k', 'l2hc_dec_itcm_48k',
...
defines_set = {
    ...
    'chip_defines': [
        ...
        "SW21_CHIP_FPGA=0", "TARGET_CHIP_SW21=0",
