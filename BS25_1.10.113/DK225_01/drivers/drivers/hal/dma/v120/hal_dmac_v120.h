 ...
 * @endif
 */
errcode_t hal_dma_v120_init(void);
 ...
 * @endif
 */
void hal_dma_v120_enable(dma_channel_t ch, bool en);
 ...
 * @endif
 */
uint32_t hal_dma_v120_get_block(dma_channel_t ch);
 ...
 * @endif
 */
void hal_dma_v120_interrupt_clear(dma_channel_t ch, hal_dma_interrupt_t int_type);
 ...
 * @endif
 */
dma_channel_t hal_dma_v120_get_idle_ch(hal_dma_handshaking_source_t source,
 ...
 * @endif
 */
errcode_t hal_dma_v120_config_single_block(dma_channel_t ch,
 ...
 * @endif
 */
errcode_t hal_dma_v120_add_lli_transfer(dma_channel_t ch,
                                        const hal_dma_transfer_base_config_t *base_cfg,
                                        hal_dma_transfer_peri_config_t *periph_cfg);
 ...
 * @endif
 */
bool hal_dma_v120_is_enabled(dma_channel_t ch);
 ...
 * @endif
 */
void hal_dma_v120_enable_lli(dma_channel_t ch, hal_dma_transfer_cb_t callback, uintptr_t arg);
