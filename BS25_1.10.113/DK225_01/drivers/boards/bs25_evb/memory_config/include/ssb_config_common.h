...
#define SSB_FOTA_REGION_START     (EMBED_FLASH_START + FOTA_IMAGE_START)
#define FOTA_IAMGE_SIGN_START     (EMBED_FLASH_START + 0x102000)
#else
#define SSB_FOTA_REGION_START (DATA_FLASH_START)
#define FOTA_IAMGE_SIGN_START     (DATA_FLASH_START + 0x2000)
#endif
...
#define FOTA_RECOVERY_SIGN_START  (FOTA_SSB_SIGN_START + 0)
#define FOTA_BT_SIGN_START        (FOTA_RECOVERY_SIGN_START + FLASH_PAGE_SIZE)
#define FOTA_NV_SIGN_START        (FOTA_BT_SIGN_START + 0)
#define FOTA_DSP_SIGN_START       (FOTA_NV_SIGN_START + 0)
#define FOTA_DSP1_SIGN_START      (FOTA_DSP_SIGN_START + 0)
