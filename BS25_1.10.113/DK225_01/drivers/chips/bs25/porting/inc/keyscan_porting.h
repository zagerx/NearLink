...
#else
#define KEYSCAN_MAX_COL                    2
#define KEYSCAN_MAX_ROW                    3
#endif
...
{                                                    \
    ...
    .wait_time         = WAITING_5_AND_5_US,         \
    .idle_time         = IDLE_3_MS_AFTER_SCAN,       \
    .defence_time      = SAMPLE_3TIMES_DEFENCE,      \
...
/**
 * @brief  Get the base address of a specified m ctrl key_int_en.
 * @return The base address of specified m ctrl key_int_en.
 */
