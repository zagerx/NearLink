 ...
 *
 * Description: APP core vector table \n
...
#define VECTOR_NUM ((ISR_VECTOR_MAX_SUPPORTED) + 1 + (RESERVED_LEN))
static isr_function g_ram_exception_table[VECTOR_NUM] __attribute__((section(".isr_vector"))) = {
