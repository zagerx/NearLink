...
/**
 * Count of Riscv system interrupt vector.
 */
#define RISCV_SYS_VECTOR_CNT        26

/**
 * Count of Riscv local interrupt vector 0 - 5, enabled by CSR mie 26 -31 bit.
 */
#define RISCV_MIE_IRQ_VECTOR_CNT        6

/**
 * Count of Riscv local interrupt vector 6~76, enabled by custom CSR locie0~2.
 */
#define RISCV_CUSTOM_IRQ_VECTOR_CNT       60

/**
 * Count of Riscv local IRQ interrupt vector.
 */
#define RISCV_LOCAL_IRQ_VECTOR_CNT        (RISCV_MIE_IRQ_VECTOR_CNT + RISCV_SYS_VECTOR_CNT)

/**
 * Count of Riscv interrupt vector.
 */
