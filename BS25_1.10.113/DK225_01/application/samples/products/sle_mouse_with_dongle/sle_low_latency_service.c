...
#else
    sle_low_latency_dongle_callbacks_t cbk_func = {NULL};
    cbk_func.report_cb = (low_latency_report_callback)usb_sle_high_mouse_report;
    sle_low_latency_dongle_register_callbacks(&cbk_func);
#endif
}
