...
static uint8_t g_local_name[NAME_MAX_LENGTH] = {'b', 'l', 'e', '_', 'm', 'o', 'u', 's', 'e'};
...
static uint8_t ble_set_adv_appearance(uint8_t *set_adv_data_position, uint8_t max_len)
{
    ...
    ble_appearance_t adv_appearance_data = {
        ...
        .catogory_id = { u16_low_u8(GAP_BLE_APPEARANCE_TYPE_MOUSE), u16_high_u8(GAP_BLE_APPEARANCE_TYPE_MOUSE) },
    };
