...
#if defined(CONFIG_SLE_PDM_AMIC_SAMPLE_RATE_8K)
    .sample_rate = 8000,
#elif defined(CONFIG_SLE_PDM_AMIC_SAMPLE_RATE_16K)
    .sample_rate = 16000,
#elif defined(CONFIG_SLE_PDM_AMIC_SAMPLE_RATE_32K)
    .sample_rate = 32000,
#elif defined(CONFIG_SLE_PDM_AMIC_SAMPLE_RATE_48K)
    .sample_rate = 48000,
#elif defined(CONFIG_SLE_PDM_AMIC_SAMPLE_RATE_96K)
    .sample_rate = 96000,
#endif
