 ...
 *
 * Description: SLE AMIC VDT Server Source. \n
...
static uint16_t g_conn_update = 0;
static uint8_t g_sle_amic_server_conn_state = SLE_ACB_STATE_NONE;
static uint32_t g_sle_amic_pair_status = 0;
...
uint8_t get_g_ssaps_server_id(void)
{
    return g_server_id;
}
    ...
    sle_acb_state_t conn_state, sle_pair_state_t pair_state, sle_disc_reason_t disc_reason)
{
    ...
    g_sle_amic_server_conn_state = conn_state;
}
...
uint32_t get_g_sle_amic_pair_state(void)
{
    return g_sle_amic_pair_status;
}

uint8_t get_g_sle_amic_server_conn_state(void)
{
    return g_sle_amic_server_conn_state;
}
...
uint16_t get_g_conn_update(void)
{
