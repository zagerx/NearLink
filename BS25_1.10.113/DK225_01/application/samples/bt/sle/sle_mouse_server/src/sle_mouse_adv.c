 ...
 * Description: Sle Mouse ADV source.
...
/* 连接调度间隔25ms，单位125us */
#define SLE_ADV_INTERVAL_MIN_DEFAULT              0xF0
/* 连接调度间隔25ms，单位125us */
#define SLE_ADV_INTERVAL_MAX_DEFAULT              0xF0
/* 超时时间5000ms，单位10ms */
...
static uint8_t g_sle_adv_data[SLE_ADV_DATA_LEN] = {
    ...
    // appearance
    0x03,
    0x13, 0x09, 0x06, 0x07, 0x03, 0x02, 0x05, 0x00,
    0x06, 0x0A,
    't', 'o', 'o', 't', 'h', 'b', 'r', 'u', 's', 'h'
};
...
static uint8_t g_sle_adv_rsp_data[SLE_ADV_RSP_DATA_LEN] = {
    0x0B,
    0x0A, 't', 'o', 'o', 't', 'h', 'b', 'r', 'u', 's', 'h'
};

static uint8_t g_sle_mac_addr[BD_ADDR_LEN6] = {0x33, 0x22, 0x22, 0x66, 0x11, 0x22};
...
static int sle_set_default_announce_param(void)
{
    ...
    if (memcpy_s(param.own_addr.addr, BD_ADDR_LEN6, g_sle_mac_addr, BD_ADDR_LEN6) != EOK) {
        sample_at_log_print("set sle adv param memcpy addr fail\r\n");
